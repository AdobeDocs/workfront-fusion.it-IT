...
Per utilizzare un webhook per connettere un’app a Workfront Fusion, puoi impostarlo per l’autenticazione utilizzando un certificato client (mTLS) o l’autenticazione di base.
