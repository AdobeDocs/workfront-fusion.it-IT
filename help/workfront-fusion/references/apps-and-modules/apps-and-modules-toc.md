...
title: 'Documentazione di riferimento per applicazioni e moduli in Fusion: indice articoli'
description: Questa sezione contiene materiali di riferimento per la configurazione di moduli specifici in Adobe Workfront Fusion.
author: Becky
...
# Documentazione di riferimento per applicazioni e moduli in Fusion: indice articoli

>[!IMPORTANT]
>
>Adobe Workfront Fusion è in grado di collegarsi a quasi tutti i servizi web. Non si limita solo alle app presenti in questo elenco. Se l’app che desideri utilizzare non è inclusa nell’elenco, utilizza uno dei connettori universali per la connessione all’app o al servizio web.

## Connettori universali

Questi connettori consentono di connetterti a qualsiasi app o servizio web che dispone di un’API pubblica.
...
Fusion offre connettori per diversi prodotti e servizi Adobe.
...
* [Moduli di Adobe Content Tagger](/help/workfront-fusion/references/apps-and-modules/adobe-connectors/content-tagging-modules.md)
...
* [Moduli MCP di Adobe Experience Manager](/help/workfront-fusion/references/apps-and-modules/adobe-connectors/aem-mcp-modules.md)
...
* [Moduli MCP di Adobe Workfront](/help/workfront-fusion/references/apps-and-modules/adobe-connectors/workfront-mcp-modules.md)
...
Fusion offre connettori per diverse applicazioni di terze parti.
...
Questi moduli ti consentono di eseguire azioni sui tuoi dati, ma non richiedono la connessione a servizi esterni a Fusion.
