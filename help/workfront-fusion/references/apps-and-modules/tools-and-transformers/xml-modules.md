...
1. Modificare il nome della struttura dati in un nome più specifico e fare clic su **[!UICONTROL Save]**.
...
1. Aggiungi il modulo [!UICONTROL HTTP] > [!UICONTROL Get a file]
