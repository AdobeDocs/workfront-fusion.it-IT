...
# Moduli [!DNL Adobe Lightroom]

In uno scenario Adobe Workfront Fusion, puoi automatizzare i flussi di lavoro che utilizzano [!DNL Adobe Lightroom], nonché collegarli a più applicazioni e servizi di terze parti.
...
Quando configuri i moduli [!DNL Adobe Lightroom], in Workfront Fusion vengono visualizzati i campi elencati di seguito. Insieme a questi, potrebbero essere visualizzati altri campi di [!DNL Adobe Lightroom], a seconda di fattori quali il tuo livello di accesso nell’app o nel servizio. Un titolo in grassetto in un modulo indica un campo obbligatorio.
...
<table style="table-layout:auto"> 
  ...
  <tbody>
    <tr>
      ...
      <td>Per istruzioni sulla creazione di una connessione a [!DNL Adobe Lightroom], consulta <a href="#create-a-connection-to-adobe-lightroom" class="MCXref xref" >Creare una connessione a [!DNL Adobe Lightroom]</a> in questo articolo.</td>
    </tr>
    <tr>
...
<table style="table-layout:auto"> 
  ...
  <tbody>
    ...
    <tr>
      <td role="rowheader">[!UICONTROL Nascondi le risorse all'interno di pile?"]</td>
      <td>
