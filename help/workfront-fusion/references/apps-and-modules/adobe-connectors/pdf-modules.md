...
1. In qualsiasi modulo [!DNL Adobe PDF Services], fare clic su **[!UICONTROL Add]** accanto alla casella Connessione.
   ...
   <table style="table-layout:auto"> 
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Immetti [!DNL Adobe] [!UICONTROL Technical account ID]. È disponibile nella sezione [!UICONTROL Credentials details] di [!DNL Adobe Developer Console].<p>Per istruzioni su come individuare le credenziali, vedi <a href="https://developer.adobe.com/developer-console/docs/guides/services/services-add-api-oauth/#credentials" class="MCXref xref" >Credenziali</a> nella documentazione per gli sviluppatori di Adobe.</p>
        </tr>
        <tr>
          <td role="rowheader">[!UICONTROL Organization ID] (solo JWT)</td>
          <td>Immetti [!DNL Adobe] [!UICONTROL Organization ID]. È disponibile nella sezione [!UICONTROL Credentials details] di [!DNL Adobe Developer Console].<p>Per istruzioni su come individuare le credenziali, vedi <a href="https://developer.adobe.com/developer-console/docs/guides/services/services-add-api-oauth/#credentials" class="MCXref xref" >Credenziali</a> nella documentazione per gli sviluppatori di Adobe.</p>
        </tr>
        <tr>
...
Il modulo [!UICONTROL Generate document] è un modo efficace per creare un PDF contenente i dati selezionati. È possibile formattarlo utilizzando un modello [!DNL Microsoft Word] o fornendo dati in formato JSON.

Per ulteriori informazioni sulla funzionalità [!UICONTROL [!DNL Adobe PDF Services] Generate document], vedere la [Panoramica sulla generazione di documenti](https://www.adobe.io/apis/documentcloud/dcsdk/docs.html) nella documentazione di [!DNL Adobe Document Services].

* [Utilizza il modulo [!UICONTROL Generate document] con un [!DNL Microsoft Word] modello](#use-the-generate-document-module-with-a-microsoft-word-template)
* [Utilizza il modulo [!UICONTROL Generate document] con JSON](#use-the-generate-document-module-with-json)

#### Utilizza il modulo [!UICONTROL Generate document] con un modello [!DNL Microsoft Word]
...
>
>Non è necessario utilizzare i moduli modello di Microsoft Word per utilizzare un modello di Microsoft Word con il modulo documento Generate di PDF Services.


Per utilizzare il modulo [!UICONTROL Generate document] con un modello [!UICONTROL Microsoft Word], è necessario innanzitutto creare il modello. Per istruzioni, cercare &quot;Crea un modello&quot; nella documentazione di [!DNL Microsoft Office].

Compila i campi del modulo [!UICONTROL Generate document] come segue:
  ...
  <tr> 
   ...
   <td> <p>Per ogni tag di valore nel modello che si desidera sostituire con testo, compilare il modulo seguente:</p> 
    <ul> 
     ...
     <li> <p>[!UICONTROL Value]</p> <p>Immettere o mappare il testo che si desidera visualizzare nel documento generato al posto del tag value.</p> </li> 
...
#### Utilizza il modulo [!UICONTROL Generate document] con JSON

Per utilizzare il modulo [!UICONTROL Generate document] con JSON, compila i campi come segue:
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     <li> <p>[!UICONTROL Modified original image] il testo assicura che il testo sia ricercabile e selezionabile, ma modifica l'immagine originale durante il processo di pulizia (ad esempio, lo disegna) prima di posizionarvi sopra un livello di testo invisibile. Questo tipo rimuove gli artefatti indesiderati e può risultare in un documento più leggibile in alcuni scenari. </p> </li> 
     <li> <p>[!UICONTROL Unchanged original image] testo consente inoltre di sovrapporre un livello di testo ricercabile all'immagine originale, ma in questo caso l'immagine originale rimane invariata. Questo tipo produce la massima fedeltà all'immagine originale.</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Selezionare l'azione da eseguire sul file.</p> 
    <ul> 
     <li> <p><b>[!UICONTROL Delete]</b> </p> <p>Selezionare questa opzione per eliminare le pagine dal documento.</p><p>Per ogni intervallo di pagine che si desidera eliminare, fare clic su <strong>[!UICONTROL Add]</strong> e quindi immettere la prima e l'ultima pagina dell'intervallo. </p> <p>Nota:   
     <ul> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Abilita questa opzione per generare un rapporto che elenca i problemi di accessibilità in PDF e la loro posizione e fornisce suggerimenti su come risolverli.</p> </td> 
  </tr> 
 </tbody> 
</table>
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Selezionare l'algoritmo di crittografia. </p> 
    <ul> 
     <li> <p>[!UICONTROL AES-128 encryption]</p> <p>La password supporta solo caratteri LATIN-I. </p> </li> 
     <li> <p>[!UICONTROL AES-256 encryption]</p> <p>La password supporta il set di caratteri Unicode</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>Selezionare il tipo di contenuto da crittografare.</p> 
    ...
    </ul> <p>Se si seleziona "[!UICONTROL Only embedded data]", le autorizzazioni di accesso fornite risultano inattive.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Permissions]</td> 
   <td> <p>Selezionare le autorizzazioni da includere per consentire la stampa, la modifica o la copia del contenuto.</p> <p>Le impostazioni delle autorizzazioni vengono utilizzate solo se [!UICONTROL Owner Password] è impostato nel campo [!UICONTROL Password Protection Type].</p> </td> 
  </tr> 
 </tbody> 
</table>
