...
## Connessione [!DNL Frame.io] a [!UICONTROL Adobe Systems Workfront Fusion]
   ...
   <table style="table-layout:auto"> 
      ...
      <tbody>
        <tr>
          ...
          <td>
            <p>Seleziona se desideri creare una connessione di autenticazione utente IMD o una connessione da server IMS a server.</p>
          </td>
        </tr>
        <tr>
          <td role="rowheader">[! Nome connessione UICONTROL]</td>
          <td>
...
Questo modulo azioni recupera risorsa dettagli.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Inserisci il numero del fotogramma nel video a cui deve essere collegato il commento.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[! UICONTROL Pagina] </td> 
   <td> <p>Se il risorsa è un PDF, immettere o mappare la pagina a cui allegare il commento.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Seleziona il account o mappa l'ID del account che contiene il commento che desideri eliminare.</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[! ID account UICONTROL] </td> 
   <td> <p>Selezionate o mappate le account in cui desiderate creare una cartella.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[! ID Area di lavoro UICONTROL] </td> 
   <td> <p>Selezionare o mappare l'area di lavoro in cui si desidera creare una cartella.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[! ID Progetto UICONTROL] </td> 
   <td> <p>Seleziona la posizione in cui desideri creare la cartella.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[! Percorso UICONTROL] </td> 
   <td> <p>Selezionare il percorso in cui si desidera creare una cartella.</p> </td> 
  </tr> 
   <tr> 
   <td role="rowheader">Nome </td> 
   <td> <p>Immettete o mappate un nome per la nuova cartella.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
Questo modulo azioni crea un nuovo progetto in Frame.io.
...
* [Aggiungere un risorsa a un collegare di condivisione](#add-an-asset-to-a-share-link)
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Per ogni risorsa che desideri aggiungere al collegare di condivisione, fai clic su <b>Aggiungi elemento</b> e immetti l'ID del risorsa.</p> </td> 
  </tr> 
   <tr> 
   <td role="rowheader">Descrizione </td> 
   <td> <p>Immetti o mappa una descrizione per il collegare di condivisione.</p> </td> 
  </tr> 
   <tr> 
   <td role="rowheader">Nome </td> 
   <td> <p>Immetti o mappa la data di scadenza del collegare di condivisione.</p> </td> 
  </tr> 
   <tr> 
   <td role="rowheader">Nome </td> 
   <td> <p>Immetti o mappa un nome per il nuovo collegare di condivisione.</p> </td> 
  </tr> 
   <tr> 
   <td role="rowheader">Nome </td> 
   <td> <p>Inserite o mappate una passphrase per il collegare di condivisione.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
Questo modulo azioni crea una nuova area di lavoro in Frame.io
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[! ID account UICONTROL] </td> 
   <td> <p>Selezionare o mappare il account in cui si desidera creare un'area di lavoro.</p> </td> 
  </tr> 
  <tr> 
...
Questo modulo elenca tutte le aree di lavoro in un account.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>[! Metodo UICONTROL]</p> </td> 
