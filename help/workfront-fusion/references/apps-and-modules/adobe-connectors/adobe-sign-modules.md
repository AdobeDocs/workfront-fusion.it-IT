...
description: Con i moduli [!DNL Adobe Acrobat Sign] è possibile avviare uno scenario Adobe Workfront Fusion basato sugli eventi nell'account Acrobat Sign [!DNL Adobe], creare, leggere o aggiornare accordi e altri record, cercare record utilizzando i criteri impostati e caricare i documenti.
author: Becky
...
![Firma esempio](/help/workfront-fusion/references/apps-and-modules/assets/sign-example-2-350x356.png)
