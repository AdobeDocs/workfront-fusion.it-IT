...
# Moduli [!DNL Allocadia]

In uno scenario Adobe Workfront Fusion, puoi automatizzare i flussi di lavoro che utilizzano [!DNL Allocadia], nonché collegarli a più applicazioni e servizi di terze parti.
...
## Connettere [!DNL Allocadia] a Workfront Fusion
...
## Moduli [!DNL Allocadia] e relativi campi

Quando configuri i moduli [!DNL Allocadia], in Workfront Fusion vengono visualizzati i campi elencati di seguito. Insieme a questi, potrebbero essere visualizzati altri campi di [!DNL Allocadia], a seconda di fattori quali il tuo livello di accesso nell’app o nel servizio. Un titolo in grassetto in un modulo indica un campo obbligatorio.
...
Questo modulo di azione consente di effettuare una chiamata autenticata personalizzata all’API [!DNL Allocadia]. In questo modo puoi creare un’automazione del flusso di dati che non può essere eseguita dagli altri moduli [!DNL Allocadia].
...
<table style="table-layout:auto">
 ...
 <tbody> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Connessione]</p> </td> 
   <td> <p>Per istruzioni sulla connessione dell’account [!DNL Allocadia] a Workfront Fusion, consulta <a href="#connect-allocadia-to-workfront-fusion" class="MCXref xref">Connettere [!DNL Allocadia] a Workfront Fusion</a> in questo articolo.</p> </td> 
  </tr> 
  <tr> 
