...
1. Seleziona se utilizzi un token di accesso personale o un’autorizzazione OAuth 2.
1. Specifica un nome per la connessione.
1. (Condizionale) Se utilizzi un token di accesso personale, fai clic su Mostra impostazioni avanzate e immetti il token di accesso personale.
1. (Condizionale) Se utilizzi OAuth 2, fai clic su Show advanced settings (Mostra impostazioni avanzate) e immetti l’ID client Airtable e il segreto client.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> <p>Record</p> </td> 
   <td> <p>Immettere i valori per il nuovo record. I campi disponibili dipendono dalla tabella selezionata.</p> 
   <!--
...
Questo modulo di azione consente di effettuare una chiamata autenticata personalizzata all’API [!DNL Airtable]. In questo modo puoi creare un’automazione del flusso di dati che non può essere eseguita dagli altri moduli [!DNL Airtable].
