...
## Moduli [!DNL Box] e relativi campi

Quando configuri i moduli [!DNL Box], in Workfront Fusion vengono visualizzati i campi elencati di seguito. Insieme a questi, potrebbero essere visualizzati altri campi di [!DNL Box], a seconda di fattori quali il tuo livello di accesso nell’app o nel servizio. Un titolo in grassetto in un modulo indica un campo obbligatorio.
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Inserisci un percorso relativo a <code>https://api.box.com</code>. <p>Esempio: <code>/2.0/users/me</code></p></td> 
  </tr> 
  <tr> 
