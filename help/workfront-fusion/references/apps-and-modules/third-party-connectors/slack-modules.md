...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Immettere o mappare il timestamp del messaggio di cui si desidera recuperare le informazioni.</p> <p>Nota: è possibile recuperare la marca temporale utilizzando un altro modulo, ad esempio il modulo [!UICONTROL Watch Public Channel].</p> </td> 
  </tr> 
 </tbody> 
</table>
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Scegli come selezionare il canale in cui desideri creare un messaggio.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>Nel campo <strong>[!UICONTROL Channel ID or name]</strong>, immetti o mappa l'ID canale o il nome del canale in cui desideri pubblicare il messaggio.</p> <p>Nota: è possibile recuperare l'ID canale utilizzando il modulo [!UICONTROL List Channels].</p> </li> 
     <li> <p><strong>[!UICONTROL Select from the list]</strong> </p> <p>Seleziona il tipo di canale, quindi seleziona il canale.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Selezionare <strong>[!UICONTROL Yes]</strong> se si applicano entrambe le condizioni seguenti:</p> 
    <ul> 
  ...
  <tr> 
   ...
   <td> <p>Abilita questa opzione per consentire l’analisi automatica. </p> <p>Per ulteriori informazioni, vedere <a href="https://api.slack.com/docs/formatting">Formattazione del testo per le superfici dell'app</a> nella documentazione di [!DNL Slack].</p> <p>Nota: se nel messaggio originale sono state utilizzate [!UICONTROL Link names] o [!UICONTROL Parse message text] opzioni, è necessario specificarle anche durante l'esecuzione del modulo [!UICONTROL Update a Message].</p> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Scegli come desideri selezionare il messaggio che desideri.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>Nel campo <strong>[!UICONTROL Channel ID or name]</strong>, immetti o mappa l'ID canale o del canale che contiene il messaggio, quindi immetti <strong>[!UICONTROL Time Stamp (Message ID)]</strong> del messaggio. .</p> <p>Nota: è possibile recuperare l'ID canale utilizzando il modulo [!UICONTROL List Channels].</p> </li> 
     <li> <p><strong>[!UICONTROL Select from the list]</strong> </p> <p>Seleziona il tipo di canale, quindi il canale, infine il messaggio.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Text]</p> </td> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Parse message text]</p> </td> 
   <td> <p>Abilita questa opzione per consentire l’analisi automatica. </p> <p> Per ulteriori informazioni, vedere <a href="https://api.slack.com/docs/formatting">Formattazione del testo per le superfici dell'app</a> nella documentazione di [!DNL Slack].</p> <p>Nota: se nel messaggio originale sono state utilizzate [!UICONTROL Link names] o [!UICONTROL Parse message text] opzioni, è necessario specificarle anche durante l'esecuzione del modulo Aggiorna messaggio.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Selezionare [!UICONTROL Yes] per escludere i canali archiviati nei risultati.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Type] </td> 
...
* **Canale privato**: precedentemente [!UICONTROL Group]
* **Messaggio diretto**: in precedenza [!UICONTROL IM]
* **Canale**: [!UICONTROL Conversation] nella documentazione API, [!UICONTROL channel] nell&#39;app [!DNL Slack].
