...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td>Per istruzioni sulla connessione dell'account [!DNL OneDrive] a [!DNL Workfront Fusion], vedere <a href="/help/workfront-fusion/create-scenarios/connect-to-apps/connect-to-fusion-general.md" class="MCXref xref" data-mc-variable-override="">Creare una connessione a [!DNL Adobe Workfront Fusion] - Istruzioni di base</a></td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Watch Files/Folders]</td> 
   <td> <p>Selezionare la modalità di visualizzazione di file o cartelle:</p> 
    <ul> 
     <li> <p><b>[!UICONTROL By Created Time]</b> </p> <p>Cerca nuovi file o cartelle.</p> </li> 
     <li> <p><b>[!UICONTROL By Updated Time]</b> </p> <p>Controlla i file o le cartelle esistenti aggiornati.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Choose your [!DNL OneDrive] posizione]</td> 
   <td> <p>Seleziona la posizione da controllare:</p> 
    <ul> 
     <li> <p><b>[!UICONTROL My Drive]</b> </p> <p>Selezionare se abilitare il modulo per immettere un ID unità.</p> 
      <ul> 
       <li> <p><b>[!UICONTROL Yes]</b> </p> <p>Immettere l'ID dell'unità che si desidera controllare nel modulo.</p> </li> 
     ...
     <li> <p><b>[!UICONTROL Shared With Me]</b> </p> <p>Il modulo controlla i file condivisi con il proprietario dell'unità.</p> </li> 
     <li> <p><b>[!UICONTROL Site's Drive]</b> </p> <p>Seleziona il sito SharePoint che desideri che il modulo controlli. I Siti disponibili sono Siti seguiti dall'utente connesso.</p> </li> 
  ...
  <tr> 
   ...
   <td> <p>Selezionare il percorso in cui si desidera eseguire la ricerca:</p> 
    <ul> 
     <li> <p><b>[!UICONTROL My Drive]</b> </p> <p>Selezionare se abilitare il modulo per immettere un ID unità.</p> 
      <ul> 
       <li> <p><b>[!UICONTROL Yes]</b> </p> <p>Immettere l'ID dell'unità in cui si desidera eseguire la ricerca nel modulo.</p> </li> 
     ...
     <li> <p><b>[!UICONTROL Shared With Me]</b> </p> <p>Il modulo cerca i file che sono stati condivisi con il proprietario dell'unità.</p> </li> 
     <li> <p><b>[!UICONTROL Site's Drive]</b> </p> <p>Selezionare il sito [!DNL SharePoint] in cui si desidera eseguire la ricerca nel modulo. I Siti disponibili sono Siti seguiti dall'utente connesso.</p> </li> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Selezionare la modalità di immissione dell'ID o del percorso del file:</p> 
    <ul> 
     <li> <p><b>[!UICONTROL Enter Manually]</b> </p> <p>Seleziona questa opzione se desideri immettere direttamente l’ID o il percorso oppure mapparlo da un modulo precedente.</p> </li> 
     <li> <p><b>[!UICONTROL Select from a list]</b> </p> <p>Selezionare questa opzione se si desidera effettuare una selezione da un elenco di file o percorsi disponibili. </p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Choose your [!DNL OneDrive] posizione]</td> 
   <td> <p>Selezionare il percorso in cui si desidera eseguire la ricerca:</p> 
    <ul> 
     <li> <p><b>[!UICONTROL My Drive]</b> </p> <p>Selezionare se abilitare il modulo per immettere un ID unità.</p> 
      <ul> 
       <li> <p><b>[!UICONTROL Yes]</b> </p> <p>Immettere l'ID dell'unità che contiene il file che si desidera ottenere.</p> </li> 
       <li> <p><b>[!UICONTROL No]</b> </p> </li> 
      </ul> </li> 
     <li> <p><b>[!UICONTROL Site's Drive]</b> </p> <p>Selezionare il sito SharePoint contenente il file che si desidera ottenere. I Siti disponibili sono Siti seguiti dall'utente connesso.</p> </li> 
  ...
  <tr> 
   ...
   <td> <p>Selezionare o mappare l'unità contenente il file che si desidera ottenere. Questo campo non è disponibile se hai selezionato [!UICONTROL No] nel campo [!UICONTROL Enable to Enter a Drive ID].</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL File] / [!UICONTROL File ID] / [!UICONTROL File Path]</td> 
   <td> <p>Se hai selezionato [!UICONTROL Enter Manually], immetti o mappa l'ID o il percorso del file che desideri ottenere.</p> <p>Se hai selezionato [!UICONTROL Select from the list], seleziona il file che desideri ottenere.</p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td> <p>Selezionare il percorso che contiene il file da scaricare:</p> 
    <ul> 
     <li> <p><b>[!UICONTROL My Drive]</b> </p> <p>Selezionare se abilitare il modulo per immettere un ID unità.</p> 
      <ul> 
       <li> <p><b>[!UICONTROL Yes]</b> </p> <p>Immettere l'ID dell'unità che contiene il file da scaricare.</p> </li> 
       <li> <p><b>[!UICONTROL No]</b> </p> </li> 
      </ul> </li> 
     <li> <p><b>[!UICONTROL Site's Drive]</b> </p> <p>Selezionare il sito SharePoint contenente il file che si desidera scaricare. I Siti disponibili sono Siti seguiti dall'utente connesso.</p> </li> 
     <li> <p><b>[!UICONTROL Group's Drive]</b> </p> <p>Selezionare il gruppo la cui unità contiene il file da scaricare.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Drive ID]</td> 
   <td> <p>Selezionare o mappare l'unità contenente il file da scaricare. Questo campo non è disponibile se hai selezionato [!UICONTROL No] nel campo [!UICONTROL Enable to Enter a Drive ID].</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL File] / [!UICONTROL File ID] / [!UICONTROL File Path]</td>
   <td> <p>Se hai selezionato [!UICONTROL Enter Manually], immetti o mappa l'ID o il percorso del file da scaricare.</p> <p>Se hai selezionato [!UICONTROL Select from the list], seleziona il file da scaricare.</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Selezionare il percorso in cui si desidera caricare un file:</p> 
    <ul> 
     <li> <p><b>[!UICONTROL My Drive]</b> </p> <p>Selezionare se abilitare il modulo per immettere un ID unità.</p> 
      <ul> 
       <li> <p><b>[!UICONTROL Yes]</b> </p> <p>Selezionare l'unità contenente il file che si desidera ottenere.</p> </li> 
       <li> <p><b>[!UICONTROL No]</b> </p> </li> 
      </ul> </li> 
     <li> <p><b>[!UICONTROL Site's Drive]</b> </p> <p>Selezionare il sito [!DNL SharePoint] contenente la cartella in cui si desidera caricare un file. I Siti disponibili sono Siti seguiti dall'utente connesso.</p> </li> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Drive ID]</td> 
   <td> <p>Selezionare l'unità contenente la cartella in cui si desidera caricare un file. Questo campo non è disponibile se hai selezionato [!UICONTROL No] nel campo [!UICONTROL Enable to Enter a Drive ID].</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Selezionare il percorso in cui si desidera creare una cartella:</p> 
    <ul> 
     <li> <p><b>[!UICONTROL My Drive]</b> </p> <p>Selezionare se abilitare il modulo per immettere un ID unità.</p> 
      <ul> 
       <li> <p><b>[!UICONTROL Yes]</b> </p> <p>Selezionare l'unità in cui si desidera creare una cartella.</p> </li> 
       <li> <p><b>[!UICONTROL No]</b> </p> </li> 
      </ul> </li> 
     <li> <p><b>[!UICONTROL Site's Drive]</b> </p> <p>Selezionare il sito [!DNL SharePoint] in cui creare una cartella. I Siti disponibili sono Siti seguiti dall'utente connesso.</p> </li> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Drive ID]</td> 
   <td> <p>Selezionare l'unità in cui si desidera creare una cartella. Questo campo non è disponibile se hai selezionato [!UICONTROL No] nel campo [!UICONTROL Enable to Enter a Drive ID].</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Selezionare il percorso per il quale si desidera recuperare un collegamento di condivisione:</p> 
    <ul> 
     <li> <p><b>[!UICONTROL My Drive]</b> </p> <p>Selezionare se abilitare il modulo per immettere un ID unità.</p> 
      <ul> 
       <li> <p><b>[!UICONTROL Yes]</b> </p> <p>Immettere l'ID dell'unità contenente il file per il quale si desidera recuperare un collegamento di condivisione.</p> </li> 
       <li> <p><b>[!UICONTROL No]</b> </p> </li> 
      </ul> </li> 
     <li> <p><b>[!UICONTROL Site's Drive]</b> </p> <p>Selezionare il sito SharePoint contenente il file per il quale si desidera recuperare un collegamento di condivisione. I Siti disponibili sono Siti seguiti dall'utente connesso.</p> </li> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Drive ID]</td> 
   <td> <p>Selezionare o mappare l'unità contenente il file per il quale si desidera recuperare un collegamento di condivisione. Questo campo non è disponibile se hai selezionato [!UICONTROL No] nel campo [!UICONTROL Enable to Enter a Drive ID].</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL File] / [!UICONTROL File ID] / [!UICONTROL File Path]</td> 
   <td> <p>Se hai selezionato [!UICONTROL Enter Manually], immetti o mappa l'ID file o il percorso del file per il quale desideri recuperare un collegamento di condivisione.</p> <p>Se hai selezionato [!UICONTROL Select] dall'elenco, seleziona il file per il quale desideri recuperare un collegamento di condivisione.</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Selezionare il percorso contenente il file o la cartella che si desidera spostare:</p> 
    <ul> 
     <li> <p><b>[!UICONTROL My Drive]</b> </p> <p>Selezionare se abilitare il modulo per immettere un ID unità.</p> 
      <ul> 
       <li> <p><b>[!UICONTROL Yes]</b> </p> <p>Immettere l'ID dell'unità che contiene il file o la cartella che si desidera spostare.</p> </li> 
       <li> <p><b>[!UICONTROL No]</b> </p> </li> 
      </ul> </li> 
     <li> <p><b>[!UICONTROL Site's Drive]</b> </p> <p>Selezionare il sito [!DNL SharePoint] contenente il file o la cartella che si desidera spostare. I Siti disponibili sono Siti seguiti dall'utente connesso.</p> </li> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Drive ID]</td> 
   <td> <p>Selezionare o mappare l'unità contenente il file o la cartella che si desidera spostare. Questo campo non è disponibile se hai selezionato [!UICONTROL No] nel campo [!UICONTROL Enable to Enter a Drive ID].</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Seleziona [!UICONTROL File/Folder]</td> 
  ...
  <tr> 
   ...
   <td> <p>Se hai selezionato [!UICONTROL Enter Manually], immetti o mappa l'ID o il percorso del file o della cartella che desideri spostare.</p> <p>Se hai selezionato [!UICONTROL Select] dall'elenco, seleziona il file o la cartella che desideri spostare.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Selezionare il percorso in cui si desidera spostare il file o la cartella:</p> 
    <ul> 
     <li> <p><b>[!UICONTROL My Drive]</b> </p> <p>Selezionare se abilitare il modulo per immettere un ID unità.</p> 
      <ul> 
       <li> <p><b>[!UICONTROL Yes]</b> </p> <p>Immettere l'ID dell'unità in cui spostare il file o la cartella.</p> </li> 
       <li> <p><b>[!UICONTROL No]</b> </p> </li> 
      </ul> </li> 
     <li> <p><b>[!UICONTROL Site's Drive]</b> </p> <p>Selezionare il sito [!DNL SharePoint] in cui spostare il file o la cartella. I Siti disponibili sono Siti seguiti dall'utente connesso.</p> </li> 
     <li> <p><b>[!UICONTROL Group's Drive]</b> </p> <p>Selezionare il gruppo di cui si desidera spostare il file o la cartella.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Drive ID]</td> 
   <td> <p>Selezionare o mappare l'unità contenente la cartella in cui si desidera spostare il file o la cartella. Questo campo non è disponibile se hai selezionato [!UICONTROL No] nel campo [!UICONTROL Enable to Enter a Drive ID].</p> <p>Se si lascia vuoto questo campo, il file o la cartella può essere spostato solo all'interno dello stesso [!DNL OneDrive].</p> <p>È possibile spostare file e cartelle da [!UICONTROL My Drive] a [!UICONTROL Site's Drive] o a [!UICONTROL Group's Drive]. </p> <p>È possibile spostare i file da un [!UICONTROL Site's Drive] solo nella stessa unità nello stesso sito.</p> <p>È possibile spostare i file da [!UICONTROL Group's Drive] solo nella stessa unità dello stesso gruppo.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Folder]</td> 
  ...
  <tr> 
   ...
   <td> <p>Selezionare il percorso contenente il file da copiare:</p> 
    <ul> 
     <li> <p><b>[!UICONTROL My Drive]</b> </p> <p>Selezionare se abilitare il modulo per immettere un ID unità.</p> 
      <ul> 
       <li> <p><b>[!UICONTROL Yes]</b> </p> <p>Immettere l'ID dell'unità che contiene il file o la cartella da copiare.</p> </li> 
       <li> <p><b>[!UICONTROL No]</b> </p> </li> 
      </ul> </li> 
     <li> <p><b>[!UICONTROL Site's Drive]</b> </p> <p>Selezionare il sito SharePoint contenente il file che si desidera spostare. I Siti disponibili sono Siti seguiti dall'utente connesso.</p> </li> 
     <li> <p><b>[!UICONTROL Group's Drive]</b> </p> <p>Selezionare il gruppo la cui unità contiene il file da copiare.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Drive ID]</td> 
   <td> <p>Selezionare o mappare l'unità contenente il file da copiare. Questo campo non è disponibile se hai selezionato [!UICONTROL No] nel campo [!UICONTROL Enable to Enter a Drive ID].</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p role="rowheader">[!UICONTROL File] / [!UICONTROL File ID] / [!UICONTROL File Path]</p> </td> 
   <td> <p>Se hai selezionato [!UICONTROL Enter Manually], immetti o mappa l'ID o il percorso del file da copiare.</p> <p>Se hai selezionato [!UICONTROL Select] dall'elenco, seleziona il file da copiare.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Enter a New Folder Location]</td> 
   <td> <p>Selezionare la modalità di immissione del percorso in cui si desidera copiare il file o:</p> 
    <ul> 
     <li> <p><b>[!UICONTROL Enter Manually]</b> </p> <p>Seleziona questa opzione se desideri immettere direttamente l’ID o il percorso oppure mapparlo da un modulo precedente.</p> </li> 
     <li> <p><b>[!UICONTROL Select from a list]</b> </p> <p>Seleziona questa opzione se desideri effettuare una selezione da un elenco di cartelle disponibili. </p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>Selezionare il percorso in cui si desidera copiare il filtro. Questa opzione è disponibile se si è scelto di selezionare il nuovo percorso di cartella da un elenco.</p> 
    <ul> 
     <li> <p><b>[!UICONTROL My Drive]</b> </p> <p>Selezionare se abilitare il modulo per immettere un ID unità.</p> 
      <ul> 
       <li> <p><b>[!UICONTROL Yes]</b> </p> <p>Immettere l'ID dell'unità in cui copiare il file.</p> </li> 
       <li> <p><b>[!UICONTROL No]</b> </p> </li> 
      </ul> </li> 
     <li> <p><b>[!UICONTROL Site's Drive]</b> </p> <p>Selezionare il sito [!DNL SharePoint] in cui copiare il file. I Siti disponibili sono Siti seguiti dall'utente connesso.</p> </li> 
     <li> <p><b>[!UICONTROL Group's Drive]</b> </p> <p>Selezionare il gruppo di cui si desidera copiare il file.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Drive ID]</td> 
   <td> <p>Selezionare o mappare l'unità contenente la cartella in cui si desidera copiare il file. Questo campo non è disponibile se hai selezionato [!UICONTROL No] nel campo [!UICONTROL Enable to Enter a Drive ID].</p> <p>Se si lascia vuoto questo campo, il file o la cartella può essere copiato solo all'interno dello stesso [!UICONTROL OneDrive].</p> <p>È possibile copiare file e cartelle da [!UICONTROL My Drive] a [!UICONTROL Site's Drive] o a [!UICONTROL Group's Drive]. </p> <p>È possibile copiare i file da un [!UICONTROL Site's Drive] solo nella stessa unità nello stesso sito.</p> <p>È possibile copiare i file da un [!UICONTROL Group's Drive] solo nella stessa unità dello stesso gruppo.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Folder]</td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Selezionare il percorso in cui si desidera eseguire la ricerca:</p> 
    <ul> 
     <li> <p><b>[!UICONTROL My Drive]</b> </p> <p>Selezionare se abilitare il modulo per immettere un ID unità.</p> 
      <ul> 
       <li> <p><b>[!UICONTROL Yes]</b> </p> <p>Immettere l'ID dell'unità che contiene il file o la cartella che si desidera eliminare.</p> </li> 
       <li> <p><b>[!UICONTROL No]</b> </p> </li> 
      </ul> </li> 
     <li> <p><b>[!UICONTROL Site's Drive]</b> </p> <p>Selezionare il sito [!DNL SharePoint] contenente il file o la cartella che si desidera eliminare. I Siti disponibili sono Siti seguiti dall'utente connesso.</p> </li> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Drive ID]</td> 
   <td> <p>Selezionare o mappare l'unità contenente il file o la cartella che si desidera eliminare. Questo campo non è disponibile se hai selezionato [!UICONTROL No] nel campo [!UICONTROL Enable to Enter a Drive ID].</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Seleziona [!UICONTROL File/Folder]</td> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL File] / [!UICONTROL File ID] / [!UICONTROL File Path]</td>
   <td> <p>Se hai selezionato [!UICONTROL Enter Manually], immetti o mappa l'ID o il percorso del file da eliminare.</p> <p>Se hai selezionato [!UICONTROL Select] dall'elenco, seleziona il file da eliminare.</p> </td> 
  </tr> 
 </tbody> 
</table>
