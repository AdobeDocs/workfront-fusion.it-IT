...
# Moduli [!DNL Microsoft OneDrive]

In uno scenario Adobe Workfront Fusion, puoi automatizzare i flussi di lavoro che utilizzano [!DNL OneDrive], nonché collegarli a più applicazioni e servizi di terze parti.
...
## Moduli [!DNL Microsoft OneDrive] e relativi campi

Quando configuri i moduli [!DNL OneDrive], in Workfront Fusion vengono visualizzati i campi elencati di seguito. Insieme a questi, potrebbero essere visualizzati altri campi di [!DNL OneDrive], a seconda di fattori quali il tuo livello di accesso nell’app o nel servizio. Un titolo in grassetto in un modulo indica un campo obbligatorio.
