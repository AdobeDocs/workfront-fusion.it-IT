...
title: Gestisci scenari dall'area Scenari
...
# Gestisci scenari dall&#39;area Scenari

Nell&#39;area Scenari è possibile visualizzare informazioni sugli scenari di proprietà di un team. È inoltre possibile clonare, spostare o eliminare scenari o assegnarli a un pool di lavoro specifico.
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> Per assegnare uno scenario a un pool di lavoro, è necessario essere un amministratore di Fusion. </td>
   </tr>
 </tbody> 
</table>
...
## Visualizzare e gestire scenari dall&#39;area Scenari
...
1. Per spostare uno o più scenari in una cartella, fai clic sulla casella di controllo accanto a ciascuno scenario che desideri spostare, quindi fai clic su **Sposta nella cartella** nella barra nella parte inferiore dello schermo. Nella finestra visualizzata, seleziona la cartella in cui vuoi spostare gli scenari, quindi fai clic su **Sposta**.
